export const Result = () => {
  return (
    <section className="result bg-light-slate-blue hover:opacity-85 py-6 px-8 text-center text-white items-center rounded-b-4xl">
      {" "}
      ...
      <h2 className="font-black mt-1.5 text-2xl">Great</h2>
